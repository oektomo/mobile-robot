...
def get_signallevel(cell):
    signallevel=matching_line(cell,"Quality=").split()[2].split('=')
    #print(signallevel[1])
    #print(" dBm")
...
columns=["Name","Address","Quality","Channel","Encryption","Signal_level"]
